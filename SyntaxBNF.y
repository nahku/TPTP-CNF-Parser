...
annotated_formula : fof_annotated {$<pval>$ = P_BUILD("annotated_formula", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
...
thf_formula : thf_logic_formula {$<pval>$ = P_BUILD("thf_formula", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ...
                    | thf_sequent {$<pval>$ = P_BUILD("thf_formula", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
thf_defined_atomic : defined_constant {$<pval>$ = P_BUILD("thf_defined_atomic", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ...
                    | defined_term {$<pval>$ = P_BUILD("thf_defined_atomic", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
thf_let : _DLR_let LPAREN thf_let_types COMMA thf_let_defns COMMA thf_formula RPAREN {$<pval>$ = P_BUILD("thf_let", P_TOKEN("_DLR_let ", $<ival>1), P_TOKEN("LPAREN ", $<ival>2), $<pval>3, P_TOKEN("COMMA ", $<ival>4), $<pval>5, P_TOKEN("COMMA ", $<ival>6), $<pval>7, P_TOKEN("RPAREN ", $<ival>8),NULL,NULL);}
                    ;
...
thf_sequent : thf_tuple gentzen_arrow thf_tuple {$<pval>$ = P_BUILD("thf_sequent", $<pval>1, $<pval>2, $<pval>3,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | LPAREN thf_sequent RPAREN {$<pval>$ = P_BUILD("thf_sequent", P_TOKEN("LPAREN ", $<ival>1), $<pval>2, P_TOKEN("RPAREN ", $<ival>3),NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
tff_formula : tff_logic_formula {$<pval>$ = P_BUILD("tff_formula", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ...
                    | tfx_sequent {$<pval>$ = P_BUILD("tff_formula", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
tfx_sequent : tfx_tuple gentzen_arrow tfx_tuple {$<pval>$ = P_BUILD("tfx_sequent", $<pval>1, $<pval>2, $<pval>3,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | LPAREN tfx_sequent RPAREN {$<pval>$ = P_BUILD("tfx_sequent", P_TOKEN("LPAREN ", $<ival>1), $<pval>2, P_TOKEN("RPAREN ", $<ival>3),NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
thf_unary_connective : unary_connective {$<pval>$ = P_BUILD("thf_unary_connective", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | th1_unary_connective {$<pval>$ = P_BUILD("thf_unary_connective", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;

th1_unary_connective : EXCLAMATION_EXCLAMATION {$<pval>$ = P_BUILD("th1_unary_connective", P_TOKEN("EXCLAMATION_EXCLAMATION ", $<ival>1),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | QUESTION_QUESTION {$<pval>$ = P_BUILD("th1_unary_connective", P_TOKEN("QUESTION_QUESTION ", $<ival>1),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | AT_AT_SIGN_PLUS {$<pval>$ = P_BUILD("th1_unary_connective", P_TOKEN("AT_AT_SIGN_PLUS ", $<ival>1),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | AT_AT_SIGN_MINUS {$<pval>$ = P_BUILD("th1_unary_connective", P_TOKEN("AT_AT_SIGN_MINUS ", $<ival>1),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | AT_SIGN_EQUALS {$<pval>$ = P_BUILD("th1_unary_connective", P_TOKEN("AT_SIGN_EQUALS ", $<ival>1),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
